...
import com.example.memo.databinding.FragmentTrashBinding
...
class Fragment_Trash : Fragment() {
    lateinit var home_activity: MainActivity
    private var mBinding: FragmentTrashBinding? = null
    ...
    override fun onCreateView(
        ...
        mBinding = FragmentTrashBinding.inflate(inflater, container, false)
